...
class UnicodeMethodsTest(unittest.TestCase):
    ...
    @property
    def expectedchecksum(self):
        return {(2, 6): '6ec65b65835614ec00634c674bba0e50cd32c189',
                (2, 7): '4504dffd035baea02c5b9de82bebc3d65e0e0baf'}.get(sys.version_info[:2], '')
...
class UnicodeFunctionsTest(UnicodeDatabaseTest):
    ...
    @property
    def expectedchecksum(self):
        return {(2, 6): 'ac998c2db061899227b17a75f514c3c71c11f455',
                (2, 7): '97c2dafb4c8258847339c8def763c3618d242c87'}.get(sys.version_info[:2], '')
...
class UnicodeMiscTest(UnicodeDatabaseTest):
    ...
    def test_linebreak_7643(self):
        line_breaks = [0x0a, 0x0d, 0x85, 0x1c, 0x1d, 0x1e, 0x2028, 0x2029]
        if sys.version_info[:3] >= (2, 7):
            line_breaks.extend([0x0b, 0x0c])
        for i in range(0x10000):
